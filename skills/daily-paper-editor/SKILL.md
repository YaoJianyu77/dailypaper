...
description: Write the daily digest and per-paper enrichment in concise but analysis-oriented Simplified Chinese.
---
...
7. Keep Simplified Chinese concise and high-signal, but do not compress away the reasoning.
